...
final class DiskStorageAdapter: StoragePort {
    ...
    private let store = UserDefaults(suiteName: "group.buildora.data")!
    private let cache = UserDefaults.standard
    private var memory: [String: Any] = [:]
    
    private enum Key {
        static let tracking = "bd_tracking_payload"
        static let navigation = "bd_navigation_payload"
        static let endpoint = "bd_endpoint_target"
        static let mode = "bd_mode_active"
        static let firstLaunch = "bd_first_launch_flag"
        static let permApproved = "bd_perm_approved"
        static let permDeclined = "bd_perm_declined"
        static let permDate = "bd_perm_date"
    }
